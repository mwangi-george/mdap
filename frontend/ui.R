...
ui <- fluidPage(
  ...
  div(
    ...
    textInput("api_user", label = "Username", placeholder = "Enter your username", value = "g", width = "100%"),
    passwordInput("api_pass", "Password", placeholder = "Enter your password", value = "0987", width = "100%"),
