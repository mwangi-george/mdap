...
# 
# # UI
# get_transactions_ui <- function(id, child_transactions_download_trriger = NULL){
#   ns <- NS(id)
#   tagList(
#     fluidRow(
#       child_transactions_download_trriger,
...
# 
# # Logic
# get_transactions_server <- function(id, auth_token, active_user, transactions_df){
#   moduleServer(id, function(input,output, session) {
#     # namespace to access ui elements created in the server side
#     ns <- session$ns
#     transactions_4_current_user <- transactions_df
#     
#     
#     ## Value boxes ------------
#     observe({
