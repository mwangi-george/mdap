...
server <- function(input, output, session) {
  ...
  # Post and delete transaction modules 
  observe({
...
shinyApp(
  ...
  onStart = function(){
    ...
    use_local_backend <<- readline(prompt = "Use locally running backend, > > > TRUE or FALSE: ")
    in_production <<- as.logical(use_prod_server)
  }
)
